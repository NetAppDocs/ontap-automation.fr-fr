...
---
= Options d'automatisation ONTAP
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
.Kit PowerShell
Vous pouvez utiliser le NetApp.ONTAP PowerShell Toolkit pour automatiser l'administration d'un cluster ONTAP depuis un hôte Windows. Voir link:../pstk/learn-about-pstk.html["Découvrez le NetApp ONTAP PowerShell Toolkit"] pour plus d'informations.
