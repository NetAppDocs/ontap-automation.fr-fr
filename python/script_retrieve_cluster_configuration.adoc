...
summary: 'Vous pouvez exécuter le script en utilisant Python 3 sur l"interface de ligne de commandes afin d"extraire la configuration du cluster ONTAP.' 
---
= Script pour extraire la configuration du cluster
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
