...
.Mappages de LUN
Une association LUN est une association entre un LUN et un groupe d'initiateurs. Ce type de ressource a été introduit avec ONTAP 9.6 et mis à jour avec ONTAP 9.19.1.
