...
Sécurité:: Une nouvelle `whoami` fonctionnalité a été ajoutée pour récupérer le nom d'utilisateur, le rôle et les autorisations de l'utilisateur connecté. La fonctionnalité d'authentification web (WebAuthn) a également été améliorée.
