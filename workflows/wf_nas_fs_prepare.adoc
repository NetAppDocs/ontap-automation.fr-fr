...
NOTE: Pour les versions d'ONTAP antérieures à 9.9.1, vous pouvez automatiser l'administration des autorisations SACL et DACL à l'aide de la fonction de transmission via l'interface de ligne de commande (CLI). Voir link:../migrate/migration-considerations.html["Considérations relatives à la migration"] pour plus d'informations.
